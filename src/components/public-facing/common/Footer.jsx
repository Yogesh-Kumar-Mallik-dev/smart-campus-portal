        ...
        {/* Left Block – College Info */}
          ...
          <div className="flex flex-col items-center gap-4 md:items-end">
            ...
            <div className="flex gap-5 text-xl text-foreground">
              <a
                  href="https://www.facebook.com/Babu-Banarsi-Dass-Institute-of-Technology-378556229392036/" target="_blank"
                  aria-label="Facebook"
              ...
              <a
                  href="https://www.instagram.com/bbdit.ghaziabad/?hl=en" target="_blank"
              ...
              <a
                  href="https://x.com/bbditg" target="_blank"
              ...
              <a
                  href="https://www.linkedin.com/company/babu-banarsi-das-institute-of-technology-ghaziabad/" target="_blank"
                  aria-label="LinkedIn"
                  className="hover:text-primary transition-colors"
              >
                <FaLinkedinIn />
